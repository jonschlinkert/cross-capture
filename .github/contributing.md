# Contributing to cross-capture

First and foremost, thank you! We appreciate that you want to contribute to cross-capture, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for cross-capture**

Please keep in mind that open source software is built by people who, like you, spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for cross-capture:

- star the [project](https://github.com/jonschlinkert/cross-capture)
- tweet your support for cross-capture
...
- **version**: please note the version of cross-capture are you using
...
[so]: http://stackoverflow.com/questions/tagged/cross-capture
